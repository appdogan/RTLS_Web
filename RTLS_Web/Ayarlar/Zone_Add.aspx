<%@ Page Title="" Language="C#" MasterPageFile="~/Ayarlar/sablon.Master" AutoEventWireup="true" CodeBehind="Zone_Add.aspx.cs" Inherits="RTLS_Web.Ayarlar.Zone_Add" %>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="Anchor1_ID" TextMode="Number" CssClass="form-control" runat="server">0</asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <label>İp</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="Anchor2_ID" TextMode="Number" CssClass="form-control" runat="server">0</asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <label>İp</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="Anchor3_ID" TextMode="Number" CssClass="form-control" runat="server">0</asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <label>İp</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="AnchorMaster_ID" TextMode="Number" CssClass="form-control" runat="server">0</asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <label>İp</label>
